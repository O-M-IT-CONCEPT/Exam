...
Public Class Form6
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim sql As String = "SELECT * FROM adminn WHERE admid = @admid"
        Dim sqlParameters As New List(Of SqlParameter) From {
        New SqlParameter("@admid", TextBox4.Text)
    }

        Dim dt As DataTable = Crud(sql, sqlParameters)

        If dt.Rows.Count > 0 Then
            ' Populate fields with data from the retrieved record
            Dim row As DataRow = dt.Rows(0)
            TextBox3.Text = row("fnam").ToString()
            TextBox6.Text = row("pno").ToString()
            TextBox1.Text = row("mail").ToString()
            ComboBox2.Text = row("state").ToString()
            ComboBox3.Text = row("lga").ToString()
            TextBox7.Text = row("hometwn").ToString()
            ...
            End If
        Else
            MsgBox("Admin ID not found", vbInformation, "CA")
        End If
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
       ...
       ComboBox3.Text = "Select" Then
        ...
        Dim sql As String = "UPDATE adminn SET fnam = @fnam, pno = @pno, mail = @mail, state = @state, " &
                        "lga = @lga, hometwn = @hometwn, addr = @addr, pswd = @pswd WHERE admid = @admid"
        ...
        New SqlParameter("@admid", TextBox4.Text) ' This identifies which record to update
    }
